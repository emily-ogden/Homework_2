...
test=c(82900,86700,46900,41300,91600,100400,128400,55900,101700,139100,79300,76100,114100,139800,91900,95200,61900,73600,114300,117000,129500,74200,112700,152100,90700,89400,127500,142200)
fish2=rbind(catch1,catch2)
hist(catch1,main="",xlab="2009 catch (tonnes)",breaks = 10)
hist(catch2,main="",xlab="2010 catch (tonnes)",breaks = 10)
hist(test)
```
...
$t_{crit}=2.2621$  
f)  
p=0.048 which is less than $\alpha$, indicating that there is evidence to reject the null hypothesis that the mean phosphorus levels are equal to 15 $\mu$g/L.Therefores there is evidence to support the alternative hypothesis that the mean phosphorus levels are greater than 15 $\mu$g/L.
...
salmon=c(2.3,1.8,1.9,1.8,2.1,2.3,2.0,2.2,2.2,1.5,1.8,2.1,2.3,2.2,2.3,1.6,1.1,0.7,1.0,1.0,0.9,1.2,0.8,0.9,0.6,0.7,0.6,0.8,0.8,1.1)
hist(meat,breaks= 10)
hist(veg,breaks = 10)
hist(salmon,breaks = 10)
```
